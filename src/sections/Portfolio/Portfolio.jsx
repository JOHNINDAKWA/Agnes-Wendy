  ...
  return (
    <section className="portfolio portfolio-container" id="portfolio" >
      <div className="portfolio-header" data-aos="zoom-in">
        ...
        <p className="portfolio-header-top">Data Science Projects</p>
      </div>
      ...
      <div className="portfolio-header portfolio-two" data-aos="zoom-in">
        <h1 className="portfolio-header-below">Portfolio</h1>
        <p className="portfolio-header-top">Other Projects</p>
      </div>
